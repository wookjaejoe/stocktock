...
class CpPublish:
    ...
    def __init__(self, name, serviceID):  # 'marketwatch', 'CpSysDib.CpMarketWatchS'
        self.name = name
        self.client = win32com.client.Dispatch(serviceID)
        self.bIsSB = False
    ...
    def Subscribe(self, var, caller):
        ...
        if (len(var) > 0):
            self.client.SetInputValue(0, var)

        handler = win32com.client.WithEvents(self.client, CpEvent)
        handler.set_params(self.client, self.name, caller)
